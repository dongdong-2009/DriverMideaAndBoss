...
namespace All.Window
{
    public partial class BaseWindowNormal :Form
    {
        ...
        {
            e.Graphics.DrawLine(new Pen(SystemColors.ControlDark, 1), new Point(1, 1), new Point(Width - 2, 1));
            e.Graphics.DrawLine(new Pen(SystemColors.Control, 1), new Point(0, 0), new Point(Width, 0));

            e.Graphics.DrawLine(new Pen(SystemColors.ControlDark, 1), new Point(1, 1), new Point(1, Height - 2));
            e.Graphics.DrawLine(new Pen(SystemColors.Control, 1), new Point(0, 0), new Point(0, Height));

            e.Graphics.DrawLine(new Pen(SystemColors.ControlLight, 1), new Point(1, Height - 2), new Point(Width - 2, Height - 2));
            e.Graphics.DrawLine(new Pen(SystemColors.Control, 1), new Point(0, Height - 1), new Point(Width - 1, Height - 1));

            e.Graphics.DrawLine(new Pen(SystemColors.ControlLight, 1), new Point(Width - 2, 1), new Point(Width - 2, Height - 2));
